...
request), you accept and agree to the following terms for all of your present and
future Contributions. Except for the licenses granted here, you retain all right,
...
use, offer to sell, sell, import, and otherwise transfer Your Contributions, where
...
Contribution(s) with the work to which they were submitted. If any entity
...
Contributions under any license terms, including the right to sublicense these
rights through multiple tiers of sublicensees, for the purpose of distributing,
selling, or otherwise making the Project available.
...
- Each of Your Contributions is Your original creation (see Section 6 for
  third-party material).
- Your Contributions include complete details of any third-party license or other
  restriction (including related patents and trademarks) of which you are
