...
| `FOGGY_PUBLIC_RPM` | `5` | Landing-page Foggy: requests per minute per IP. |
| `FOGGY_PUBLIC_DAILY_LIMIT` | `30` | Landing-page Foggy: messages per day per IP. |
| `FOGGY_PUBLIC_GLOBAL_DAILY_LIMIT` | `2000` | Landing-page Foggy: messages per day across all visitors. |
| `FOGGY_PUBLIC_MAX_STEPS` | `3` | Landing-page Foggy: max tool-use steps per answer. |
| `FOGGY_PUBLIC_MAX_OUTPUT_TOKENS` | `700` | Landing-page Foggy: output token cap per answer. |
