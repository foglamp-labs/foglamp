...
export function HeroDemo() {
  return (
    ...
    <div className="relative flex h-165 w-full overflow-hidden rounded-xl corner-round! backdrop-blur-3xl dark:bg-neutral-900/70  dark:shadow-(--custom-shadow) bg-sidebar">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 flex">
        ...
        <div className="m-2 ml-0 flex-1 rounded-md squircle:rounded-xl corner-squircle bg-background max-md:ml-2" />
      </div>
      <DashboardDemo />
    </div>
  );
