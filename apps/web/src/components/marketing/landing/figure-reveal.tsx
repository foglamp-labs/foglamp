...
// replays. <FigureReveal> watches the viewport once and hands the result down;
// the figure's parts read it with useReveal() and run their own beat.
//
...
export function FigureReveal({ children }: { children: ReactNode }) {
  ...
  return (
    <div ref={ref} className="min-w-0">
      <RevealContext.Provider value={{ shown: inView || reduce, reduce }}>
        {children}
