...
function PromptArt() {
	return (
		...
		>
			...
			<div className="flex h-13 items-center gap-2 rounded-full bg-card pl-5 pr-2 shadow-(--custom-shadow)">
...
function WireArt() {
	return (
		<div aria-hidden className="relative aspect-296/126 w-full">
			...
			<div className="absolute inset-0 overflow-hidden rounded-lg squircle:rounded-3xl corner-squircle bg-card shadow-(--custom-shadow)" />
			<svg
