...
export function CodeBlock({
	...
	/** Render no corner controls — the parent overlays its own (e.g. shared
	 * controls above crossfading blocks, so they don't fade with the code). */
	hideCopy?: boolean;
}) {
	...
	return (
		<div
			className={cn(
				...
				actions || hideCopy ? "[&_pre]:pt-5" : "[&_pre]:pr-10",
			)}
		>
			{html ? (
