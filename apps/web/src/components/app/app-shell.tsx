...
import { DevToolbar, useNavIconVariant } from "./dev-toolbar";
...
function ShellBody({ children }: { children: React.ReactNode }) {
	...
	return (
		<SidebarProvider className="group/shell relative h-svh min-h-0 overflow-hidden">
			...
			<SidebarInset
				className={cn(
					"min-h-0 overflow-hidden transition-shadow duration-200",
          ...
          renders it. Tree-shaken out of production builds (static NODE_ENV). */}
			...
			{/* Fixed-position dev settings toolbar (center-right edge). Renders
