...
import type { RailItem, ScanData } from "@foglamp/contracts/scan";
...
export function LeftRail({ data }: { data: ScanData }) {
	...
	return (
		<Card className="flex max-h-[50dvh] flex-col overflow-hidden rounded-[36px] squircle:rounded-[36px] py-0 pr-12 no-scrollbar">
