					...
					body: (
						<>
							<p>
								...
								address when you sign up. If you sign in with Google, we receive
								your name, email, and profile picture from your Google account,
								nothing else.
							</p>
							<p>
							...
							<p>
								...
								improve it, plus standard server logs (IP address, browser type)
				...
				},
				{
					...
					body: (
						<p>
							...
							correct, delete, or port your data. Email us and we&apos;ll honor
							them.
						</p>
					),
				},
