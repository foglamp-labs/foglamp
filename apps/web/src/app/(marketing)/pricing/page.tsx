	...
	const card = (
		<Card
			className={cn(
				...
				// Pinned to 3xl in every browser — the Card default now drops to a
				// smaller radius where corner-shape is unsupported, which would
				// misalign the beam.
				"flex flex-col rounded-3xl squircle:rounded-3xl corner-round! bg-card/90",
			)}
		>
			<CardHeader>
