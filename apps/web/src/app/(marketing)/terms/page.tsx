		...
		<LegalPage
			...
			intro={
				<p>
					...
					distributed under its own open-source license in the repository and is
			...
			sections={[
				{
					...
					body: (
						<p>
							...
							visualize traces, costs, evals, and alerts. We may add, change, or
							remove features over time; we&apos;ll give reasonable notice of
							changes that materially reduce core functionality.
						</p>
					),
				},
				{
					...
					body: (
						<>
							...
							<p>
								If you use Foglamp on behalf of an organization, you confirm you
					...
					body: (
						<>
							<p>
								...
								automatically until cancelled. You can cancel anytime from
								Settings; cancellation takes effect at the end of the current
								billing period, and except where required by law, payments are
								non-refundable.
							</p>
							<p>
				...
				},
				{
					...
					body: (
						<p>
							...
							a particular purpose and non-infringement. We don&apos;t warrant
							that the service will be uninterrupted or error-free. Foglamp is
							an observability tool. It does not make decisions for you, and you
							remain responsible for your own applications and their outputs.
						</p>
					),
				},
				{
					...
					body: (
						<p>
							...
							terms is capped at the amounts you paid us in the 12 months before
							the claim (or $100 if you&apos;re on the free plan). Nothing in
				...
				},
				{
					...
					body: (
						<p>
							...
							we&apos;ll notify you by email or in the app at least 14 days
