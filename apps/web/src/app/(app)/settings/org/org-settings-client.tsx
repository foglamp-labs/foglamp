...
function TabBar({
	...
	return (
		<div
			role="tablist"
			className="flex w-fit flex-wrap items-center gap-1 px-1"
		>
				...
				return (
					<button
						...
						className={cn(
							...
							"relative h-8 cursor-pointer rounded-md squircle:rounded-xl corner-squircle px-2.5 text-sm font-medium",
							active
								? "text-foreground"
					...
					>
						{active && (
							<motion.span
								...
								className="absolute inset-0 z-0 rounded-md squircle:rounded-xl corner-squircle bg-muted dark:bg-muted/50"
							/>
						)}
	...
	return (
		<>
          ...
          loading.tsx stays unanimated — only the page's own header fades. */}
			...
			<div
				className={cn("flex flex-col gap-6 px-6", entrance && "page-fade-in")}
			>
