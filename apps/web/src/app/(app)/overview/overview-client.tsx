...
export function OverviewClient() {
  ...
  const showFeedSkeleton = useDelayedLoading(liveFeed.isLoading);
  ...
  return (
    <>
      ...
      {/* KPIs */}
      {summary.isLoading ? (
        showSummarySkeleton ? <CardsSkeleton count={6} /> : null
      ) : (
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent>
            {models.isLoading ? (
              showModelsSkeleton ? <TableSkeleton /> : null
            ) : modelRows.length === 0 ? (
              <EmptyState
                icon={IconChartAreaFilled}
        ...
        <Card>
          ...
          <CardContent>
            {agents.isLoading ? (
              showAgentsSkeleton ? <TableSkeleton /> : null
            ) : agentRows.length === 0 ? (
              <EmptyState
                icon={IconChartAreaFilled}
      ...
      <div className="flex flex-col gap-3">
        ...
        {liveFeed.isLoading ? (
          showFeedSkeleton ? <TableSkeleton rows={4} /> : null
